      ...
      <section className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card>
            ...
            <CardContent>
              <img src="/images/feature1.jpg" alt="Feature 1" className="w-full h-48 object-cover mb-4" />
          ...
          <Card>
            ...
            <CardContent>
              <img src="/images/feature2.jpg" alt="Feature 2" className="w-full h-48 object-cover mb-4" />
          ...
          <Card>
            ...
            <CardContent>
              <img src="/images/feature3.jpg" alt="Feature 3" className="w-full h-48 object-cover mb-4" />
          ...
          <CarouselContent>
            <CarouselItem>
              <div className="flex flex-col items-center">
                <img src="/images/testimonial1.jpg" alt="User 1" className="mx-auto object-cover w-24 h-24 rounded-full" />
            ...
            <CarouselItem>
              <div className="flex flex-col items-center">
                <img src="/images/testimonial2.jpg" alt="User 2" className="mx-auto object-cover w-24 h-24 rounded-full" />
            ...
            <CarouselItem>
              <div className="flex flex-col items-center">
                <img src="/images/testimonial3.jpg" alt="User 3" className="mx-auto object-cover w-24 h-24 rounded-full" />
